...
.include "population-environment-offsets.asm"

.include "population-addresses.asm"

.include "geography-environment-offsets.asm"

.include "geography-addresses.asm"
